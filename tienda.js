...
const pedido_store = {
  ...
  categories:{
    ...
    items:{
      ...
      'I1':{
      //NOMBRE DEL ITEM
      name:'Página Web Lite',
      desc:'GRATIS hosting y dominio',
      //PRECIO BASE DEL ITEM
      price:99,
      //CANTIDAD ESCOGIDA DEL ITEM
      qty:0,
      //FUENTE DE LA IMAGEN
      img:'img/diseno-de-paginas-web-Quito.webp',
      },
      'I2':{
      name:'Publicidad y Marketing Digital',
      desc:'recibe un mes GRATIS',
      price:150,
      qty:0,
      img:'img/marketing-digital.webp',
      },
      'I3':{
      ...
      price:9.99,
      qty:0,
      img:'img/Registro-de-dominios-y-hosting.webp',
      },
      'I4':{
      name:'Diseño Publicitario RRSS',
      desc:'10 diseños para FB/ING',
      price:29.00,
      qty:0,
      img:'img/diseno-grafico-y-comunicacion-visual.webp',
      },
    },
      /*NOMBRE CATEGORIA*/
      namec:'Servicios',
    ...
    'C2':{
       items:{
        ...
        'I1':{
          ...
          qty:0,
          //FUENTE DE LA IMAGEN
          img:'img/pagina-web-empresarial-249.webp',
          },
          'I2':{
          name:'WhatsApp Ecommerce',
          price:199,
          qty:0,
          img:'img/whatsapp-ecommerce-199.webp',
          },
          'I3':{
          name:'Marketing y Publicidad Digital',
          price:150,
          qty:0,
          img:'img/marketing-y-publicidad-digital-150.webp',
          },
          'I4':{
          name:'Software WhatsApp Marketing',
          price:299,
          qty:0,
          img:'img/software-whatsapp-marketing-299.webp',
          },
      },
      namec:'Equipos',
    },
    'C3':{
      items:{
        ...
        'I1':{
          //NOMBRE DEL ITEM
          name:'Curso WhatsApp Ecommerce',
          //PRECIO BASE DEL ITEM
          price:130,
          //CANTIDAD ESCOGIDA DEL ITEM
          qty:0,
          //FUENTE DE LA IMAGEN
          img:'img/curso-whatsapp-ecommerce-130.webp',
          },
          'I2':{
          name:'Curso de Embudo de Ventas Digital',
          price:130.00,
          qty:0,
          img:'img/curso-enbudos-de-venta-digital-130.webp',
          },
          'I3':{
          name:'Extensión Chrome WhatsApp Masivo',
          price:99.00,
          qty:0,
          img:'img/extension-whatsapp-masivo.webp',
          },
          'I4':{
          name:'Curso Video Marketing y Ventas',
          price:130.00,
          qty:0,
          img:'img/curso-youtube marketing y ventas-130.webp',
          },
      },
      namec:'Mobiliario',
    },
  ...
  'C4':{
    items:{
      ...
      'I1':{
        //NOMBRE DEL ITEM
        name:'Curso Facebook Ads',
        //PRECIO BASE DEL ITEM
        price:130.00,
        //CANTIDAD ESCOGIDA DEL ITEM
        qty:0,
        //FUENTE DE LA IMAGEN
        img:'img/curso-facebook-ads-130.webp',
        },
        'I2':{
        name:'Curso WhatsApp Ecommerce',
        price:130.00,
  ...
  Object.entries(itemList).forEach(([key,item],ind) => {
    ...
    `<div class="item-card">
      ...
      <div class="item shadow mb-4">
        ...
        <h3 class="item-desc" id="">${item.desc}</h3>
...
Object.entries(pedido_store.categories).forEach(([key,item],ind) => {
  ...
  menu_sec.classList.add("owl-com");
...
document.getElementById(`gforma`).addEventListener("submit",(ev) => {
    ev.preventDefault();
    let errors ='';
...
const ItemCheckout = (itemList) => {
  ...
  var productoslistcategorya=document.getElementById('fantasma1');
...
function addItemToShoppingCart2(/*itemTitle, itemPrice, itemImage, itemCantidad, itemtotal*/) {
  ...
  Object.entries(pedido_store.categories).forEach(([key,item],ind) =>{
   ...
   if(cart_amt2 > 0){
    document.getElementById('cart_amt2').innerHTML = `${cart_amt2}`;
    setTimeout(function() {
    $(".whatecom").fadeIn(1000);
    },500);
   }
   else{
    setTimeout(function() {
    $(".whatecom").fadeOut(1000);
    },500);
}
...
var mostrarpedidof=document.querySelector('.fantasma1').textContent;
...
var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*Páginas Web Ecommerce - 2021*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
  ...
  //   }
  //  else{
    window.open(document.getElementById("enviarwa").href = "https://api.whatsapp.com/send?phone=593980687988" + whatsapp_number);
  //  }
     ...
     window.open(document.getElementById("enviarwa").href = "https://web.whatsapp.com/send?phone=593980687988" + whatsapp_number);
...
// $("#botona").on("click",function(event){
...
$('.plus').on('click', function(){
  $('#cardnegocioid2').addClass('mostrarcart');
...
// $('#cardnegocioid2').on('click', function(){
//   $('#nav').addClass('mostrarmenu23');
//   $('#cardnegocioid2').addClass('chaoboton');
// })
...
$('#cardnegocioid2,.carritobar').on('click', function(){
  $('#navcom').addClass('mostrarmenu23');
...
$('.continuar,.but34').on('click', function(){
  $('#navcom').removeClass('mostrarmenu23');
  $('.hul-2').addClass('mostrarmenu3');
 ...
 $('.seguirc,.cerrardata').on('click', function(){
  $('#navcom').removeClass('mostrarmenu23');
  $('.hul-2').removeClass('mostrarmenu3');
  $('#cardnegocioid2').removeClass('chaoboton');
})
...
// $('.seguirc').on('click', function(){$('.derechafinal').addClass('mostrarmenu23');$('#cardnegocioid2').addClass('chaoboton');})

// $('.continuar').on('click', function(){
  
//   $('#cardnegocioid2').removeClass('mostrarcart');
// })

// $('#cardnegocioid2', function(){
//   $('#nav').addClass('mostrarmenu23');
// se auto ejecuta })

// $('.seguirc ,.continuar').on('click', function(){
//   $('#nav').removeClass('mostrarmenu23');
//   $('#cardnegocioid2').removeClass('chaoboton');
// })


// $('.mostrarmenu23').on('click', function(){
//   $('#nav').removeClass('mostrarmenu23');
//   // $('#nav').removeClass('mostrarmenu23');
//   $('#cardnegocioid2').removeClass('chaoboton');
...
$('.modalv').on('click', function(){$('.modalv').addClass('nosvemos2')})
  ...
  $('#containers2a').insertAfter('#menu-container-C1');

  $('#containers2b').insertBefore('#menu-container-C2');
  $('#masvendidos').insertBefore('#menu-container-C2');


  $('#containers2c').insertBefore('#menu-container-C3');
  $('#servinew').insertBefore('#menu-container-C3');


  $('#containers2d').insertBefore('#menu-container-C4');
  $('#intronew').insertBefore('#menu-container-C4');





$('.owl-ecom').owlCarousel({
  // stagePadding: 10,
    // margin:10,
  autoplay:true,
...
// var wert=document.getElementById(`${key}-${_key}-p`);
// console.log("🚀 ~ file: tienda.js ~ line 2350 ~  wert",  wert)
...
// let ertr =document.getElementById(`${key}-${_key}-p`).addEventListener("click",() => {
...
// });
  ...
  // $('#C1-I1-p,#C1-I2-p,#C1-I3-p,#C1-I4-p').addClass('energon');
  // $('.plust').addClass('energont');
  // $('.minus').addClass('displaymq');
  // $('.quantity').addClass('displaymq');
  ...
  //     $('#C1-I1-p,#C1-I2-p,#C1-I3-p,#C1-I4-p').removeClass('energon');
  //    $('.plust').removeClass('energont');
